...
class AdminUserController extends Controller
{
    ...
    public function index()
    {
        $users  = DB::table('users')
            ...
            ->get();
        $clubs = Club::All();
        return view('pages\admin\user\index',compact("users","clubs"));
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect('/admin/user')->with('status','New user successfully added!');
