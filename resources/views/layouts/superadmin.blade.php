    ...
    <div class="sidebar" >
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Dashboard -->
          <li class="nav-item ">
            <a href="/superadmin/dashboard" class="nav-link {{ (Illuminate\Support\Facades\Route::currentRouteName() == 'dashboard.index' ? 'active' : '') }}">
          ...
          <!-- Materials -->
          <li class="nav-item ">
                <a href="/superadmin/club" class="nav-link ">
