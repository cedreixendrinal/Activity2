  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-1" style="max-height: calc(100vh - 9rem);
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-4 pb-2 mb-3 d-flex">
        ...
        <div class="info">
          <p style="color:white">{{ auth()->user()->loft_name }}</p>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Dashboard -->
          <!-- <li class="nav-item ">
            <a href="/resident/dashboard" class="nav-link ">
          ...
          <!-- Dashboard -->
            ...
            <!-- Events -->
               ...
               <!-- Materials -->
               <li class="nav-item ">
                <a href="/member/clock" class="nav-link ">
            ...
            <!-- Materials -->
                        ...
                        <!-- Materials -->
                        <li class="nav-item ">
                <a href="/member/result" class="nav-link ">
                <i class="fa fa-book fa-lg" aria-hidden="true"></i>
                    <p>
                       Race Result
                        <i class="fas right"></i>
            ...
            <!-- Materials -->
                        ...
                        <!-- Materials -->
                        <li class="nav-item ">
                <a href="/member/log" class="nav-link ">
                <i class="fa fa-book fa-lg" aria-hidden="true"></i>
                    <p>
                       Logs
                        <i class="fas right"></i>
   ...
   <li class="nav-item ">
            ...
            <!-- Materials -->
               ...
               <!-- Materials -->
               <!-- <li class="nav-item ">
                <a href="/resident/client" class="nav-link ">
                <i class="fa fa-book fa-lg" aria-hidden="true"></i>
                    <p>
                    Manage Account
                        <i class="fas right"></i>
