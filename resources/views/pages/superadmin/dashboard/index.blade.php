...
<div style="  margin-left: 180px;
  ...
  width: 100%;">
        ...
        <a href="/superadmin/admin" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
        </div>
        ...
        <div class="inner">
        <h3>{{ $club_count }}</sup></h3>
        <p>Total Club</p>
        </div>
        <div class="icon">
        <i class="ion ion-stats-bars"></i>
        </div>
        <a href="/superadmin/club" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
        </div>
        </div>
</div>
