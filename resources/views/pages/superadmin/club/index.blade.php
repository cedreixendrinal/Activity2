...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1">Club</h4>
          </div>
                       ...
                       <div class="modal-dialog  " role="document">
                         <div class="modal-content">
                           <div class="modal-header">
                             <h5 class="modal-title" id="exampleModalScrollableTitle">Club Information</h5>
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                               <span aria-hidden="true">&times;</span>
                             </button>
                           </div>
                           <div class="modal-body">
                             <form action="/superadmin/club" method="POST" enctype="multipart/form-data">
                               @csrf
                ...
                <table class="table table-head-fixed text-nowrap table-striped table-hover" id="myTable" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$club ->id }}</td>
                      <td class="align-middle">{{$club ->name}}</td>
                      <td class="align-middle">{{$club ->description}}</td>
                      <td class="align-middle">
                          {{-- update modal --}}
                          <button type="button" data-id="{{ $club->id }}"  class="btn editbtn" style="background: none;
                          color: inherit;
                          border: none;
                          padding: 0;
                          font: inherit;
                          ...
                          <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel"> Update Club Information </h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
  ...
  $(document).ready(function () {
    ...
    $('body').on('click', '.editbtn', function () {
      ...
      $('#editmodal').modal('show');
         ...
         let updateroutes = "/superadmin/club/"+id;
          $("#updateroute").attr("action", updateroutes);


      $.get('/superadmin/club/'+id+'/edit', function (data) {
        console.log(data);
           $('#name2').val(data.name);
